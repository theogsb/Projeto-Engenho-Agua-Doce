...
public:
    ...
    void setupUi(QDialog *tela_principal)
    {
        ...
        pushButton_retirar->setObjectName("pushButton_retirar");
        ...
        pushButton_atualizar_tabela->setObjectName("pushButton_atualizar_tabela");
        pushButton_atualizar_tabela->setGeometry(QRect(30, 260, 101, 31));
